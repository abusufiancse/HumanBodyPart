...
class _HumanAnatomyState extends State<HumanAnatomy> {
  ...
  Widget bodyPart(String svgPath, String svgName, double marginTop,
    ...
    MaterialAccentColor? _svgColor =
        _bodyPartList.contains(svgName) ? Colors.redAccent : null;
    final Widget bodyPartSvg =
        SvgPicture.asset(svgPath, semanticsLabel: svgName, color: _svgColor);
    return Container(
      margin:
