    ...
    return SizedBox(
      ...
      child: Stack(
        children: <Widget>[
          ...
          bodyPart(
              "assets/left_soulder.svg", "leftSoulder", 90.0, 105.0, 0.0, 50.0),
          bodyPart("assets/right_soulder.svg", "rightSoulder", 89.0, 0.0, 110.0,
              50.0),
          bodyPart("assets/left_arm.svg", "leftArm", 120.0, 145.0, 0.0, 70.0),
          bodyPart("assets/right_arm.svg", "rightArm", 118.0, 0.0, 142.0, 70.0),
          bodyPart(
              "assets/left_elbow.svg", "leftElbow", 172.0, 172.0, 0.0, 39.0),
          bodyPart(
              "assets/right_elbow.svg", "rightElbow", 170.0, 0.0, 170.0, 40.0),
          bodyPart("assets/left_forearm.svg", "leftForearm", 195.0, 190.0, 0.0,
              54.0),
          ...
          bodyPart(
              "assets/right_wrist.svg", "rightWrist", 238.0, 0.0, 220.0, 23.0),
          ...
          bodyPart(
              "assets/right_thigh.svg", "rightThigh", 242.0, 0.0, 63.0, 138.0),
          bodyPart("assets/left_knee.svg", "leftKnee", 360.0, 68.0, 0.0, 48.0),
          bodyPart(
              "assets/right_knee.svg", "rightKnee", 360.0, 0.0, 68.0, 48.0),
          bodyPart("assets/left_leg.svg", "leftLeg", 395.0, 64.0, 0.0, 105.0),
          bodyPart("assets/right_leg.svg", "rightLeg", 393.0, 0.0, 65.0, 106.0),
          bodyPart(
              "assets/left_ankle.svg", "leftAnkle", 495.0, 64.0, 0.0, 25.0),
          bodyPart(
              "assets/right_ankle.svg", "rightAnkle", 493.0, 0.0, 68.0, 25.0),
          bodyPart("assets/left_foot.svg", "leftFoot", 510.0, 80.0, 0.0, 60.0),
          bodyPart(
